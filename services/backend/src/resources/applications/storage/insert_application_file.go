...
func (s *ApplicationsStorage) InsertApplicationFile(tx *sqlx.Tx, fileName, fileType string, fileSize uint, fileHash string) (uuid.UUID, customerrors.ErrorInterface) {
