...
func (h *RAGHandler) InsertRagConversationStudierende(c fiber.Ctx) error {
	...
	conversationID, conversationIDErr := h.service.InsertRagConversation(nil, userID, consts.BafögTypeStudent)
