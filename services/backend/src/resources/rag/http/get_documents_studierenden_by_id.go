...
func (h *RAGHandler) GetDocumentsStudierendenByID(c fiber.Ctx) error {
	...
	document, documentModel, documentErr := h.service.GetDocumentStudierendenByID(nil, fileIDString)
	if documentErr != nil {
