...
func (s *RAGStorage) DeleteRagVectorSchueler(tx *sqlx.Tx, documentID uuid.UUID) customerrors.ErrorInterface {
	sqlquery := `DELETE FROM rag_schueler WHERE cmetadata->>'originDocumentID' = $1`
