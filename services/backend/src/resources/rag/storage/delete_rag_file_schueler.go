...
func (s *RAGStorage) DeleteRagFileSchueler(tx *sqlx.Tx, documentID uuid.UUID) customerrors.ErrorInterface {
	sqlquery := `DELETE FROM pgvector_rag_schuelerbafoeg_files WHERE id::text = $1`
